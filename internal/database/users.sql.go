...
UPDATE users SET updated_at = NOW(), hashed_password = $2, email = $3 WHERE id = $1 RETURNING id, email, created_at, updated_at, hashed_password, is_chirpy_red
`
...
UPDATE users SET updated_at = NOW(), is_chirpy_red = true WHERE id = $1 RETURNING id, email, created_at, updated_at, hashed_password, is_chirpy_red
`
